...
class BroadCastManager(
    ...
    companion object {
        ...
        fun onReceivedTouchIconUrl(
            context: Context, key: Int, url: String?,
            precomposed: Boolean
        ) {
        ...
        fun onDownloadStart(
            context: Context, key: Int, url: String?, userAgent: String?,
